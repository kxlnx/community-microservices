...
import com.nowcoder.post.dao.DiscussPostMapper;
...
public class DiscussPostService {
    ...
    public List<DiscussPost> findDiscussPostsByIds(List<Integer> ids) {
        return discussPostMapper.selectDiscussPostsByIds(ids);
    }
    ...
    public int incrementCommentCount(int id) {
        return discussPostMapper.incrementCommentCount(id);
    }
